...
if ( ! function_exists( 'diza_tbay_check_data_responsive' ) ) {
    function diza_tbay_check_data_responsive($desktop, $desktopsmall, $tablet, $landscape_mobile, $mobile) {
    	$data_array = array();
...
if ( ! function_exists( 'diza_tbay_check_data_responsive_carousel' ) ) {
    function diza_tbay_check_data_responsive_carousel($columns, $desktop, $desktopsmall, $tablet, $landscape_mobile, $mobile) {
    	$data_responsive = diza_tbay_check_data_responsive($desktop, $desktopsmall, $tablet, $landscape_mobile, $mobile);
...
// Search In Options
if ( !function_exists('diza_tbay_search_in_options') ) {
    function diza_tbay_search_in_options() {
       
		$search_in = diza_tbay_get_config('search_in_options', 'only_title');
    ...
    add_filter( 'diza_search_in_options', 'diza_tbay_search_in_options' ); 
}
...
if(!function_exists('diza_localize_translate')) {
	function diza_localize_translate() { 
	    ...
	    if( defined('DIZA_WOOCOMMERCE_ACTIVED') && DIZA_WOOCOMMERCE_ACTIVED ) {  
	        ...
	        $config['popup_cart_icon']      = apply_filters( 'diza_popup_cart_icon', '<i class="tb-icon tb-icon-cross"></i>',2 );
